...
class EmployeService
{
    ...
    public function editEmployeService($oldCIN,$nom,$prenom,$dateNaissance,$tel,$email,$sexe,$adresse,$nbrEnfant,$passwd,$photo,$role,$dateRecrutement,$codeF,$codeC,$num){
    ...
    public function getAllEmployeService(){
        ...
        foreach ($listEmployeDAO as $E){
            $listE[] = new Employe($E->CIN,$E->nom,$E->prenom,$E->dateNaissance,$E->tel,$E->email,$E->sexe,$E->adresse,$E->nbrEnfant,$E->passwd,$E->photo,$E->role,$E->dateRecrutement,$E->codeF,$E->codeC,$E->num);
        }
        return $listE;
    }
    ...
    public function getEmployeByCINService($CIN){
        $E = $this->eDAO->getEmployeByCIN($CIN);
        return new Employe($E->CIN,$E->nom,$E->prenom,$E->dateNaissance,$E->tel,$E->email,$E->sexe,$E->adresse,$E->nbrEnfant,$E->passwd,$E->photo,$E->role,$E->dateRecrutement,$E->codeF,$E->codeC,$E->num);
    }
    public function login($email){
        $E = $this->eDAO->getEmployeByEmail($email);
        return new Employe($E->CIN,$E->nom,$E->prenom,$E->dateNaissance,$E->tel,$E->email,$E->sexe,$E->adresse,$E->nbrEnfant,$E->passwd,$E->photo,$E->role,$E->dateRecrutement,$E->codeF,$E->codeC,$E->num);
    }
}
