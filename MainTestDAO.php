...
$emp1 = new EmployeDAO();
$emp1 = new Employe('EE112233','jokhakh','mohamed','1997-09-25','066666666',
                                        'jok@gmail.com','homme','kech',8,'admin','amine.jpg'
                                        ,'admin','2019-01-01','F1','C1',1);
$empDao = new EmployeDAO();
$empDao->addEmploye($emp1);
/*
function affiche($x){
    echo "<table>
        <tr>
